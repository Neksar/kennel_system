...
13. Создать [класс с Инкапсуляцией методов](https://github.com/Neksar/kennel_system/tree/main/System/src/Model) и наследованием по диаграмме.
...
15. Создайте класс [Счетчик](https://github.com/Neksar/kennel_system/tree/main/System/src/Controller), у которого есть метод add(), увеличивающий̆
